...
public class FusionEdgeSource extends RichFunction implements SourceFunction<IEdge<Pair<Long, VertexType>,EdgeValue>> {
    ...
    List<IEdge<Pair<Long, VertexType>,EdgeValue>> edgeList;
    ...
    @Override
    public boolean fetch(IWindow<IEdge<Pair<Long, VertexType>, EdgeValue>> window, SourceContext<IEdge<Pair<Long, VertexType>, EdgeValue>> ctx) throws Exception {
        ...
        while (readPos < listSize) {
            IEdge<Pair<Long, VertexType>, EdgeValue> out = edgeList.get(readPos);
