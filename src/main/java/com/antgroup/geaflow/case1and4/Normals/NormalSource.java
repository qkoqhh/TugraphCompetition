package com.antgroup.geaflow.case1and4.Normals;
...
public class NormalSource<OUT> extends RichFunction implements SourceFunction<OUT> {
    private static final Logger LOGGER = LoggerFactory.getLogger(NormalSource.class);
    ...
    public NormalSource(String filePath, FileLineParser<OUT> parser) {
