...
public class Case4ConfigKeys {
    public static final ConfigKey SOURCE_PARALLELISM = ConfigKeys.key("geaflow.source.parallelism").defaultValue(1).description("job source parallelism");
    public static final ConfigKey SINK_PARALLELISM = ConfigKeys.key("geaflow.sink.parallelism").defaultValue(1).description("job sink parallelism");
    ...
    public static final ConfigKey ITERATOR_PARALLELISM = ConfigKeys.key("geaflow.iterator.parallelism").defaultValue(1).description("job iterator parallelism");
